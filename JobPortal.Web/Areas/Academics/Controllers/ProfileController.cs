    ...
    public class ProfileController : Controller
    {
        ...
        public async Task<IActionResult> Steps(int id)
        {
            ...
            var sections = await _db.FormSections
                .Where(s => s.IsActive && s.FormTypeCategoryId == 2 && s.Title != "Profile")
        ...
        [HttpPost]
        public async Task<IActionResult> Steps(Dictionary<int, string> answers, List<IFormFile> files, string actionType, int ProfileId)
        {
            try
            {
        ...
        public async Task<IActionResult> Edit(JobPortal.Domain.Models.EmployerProfile vm, Dictionary<int, string> answers, List<IFormFile> files)
        {
            ...
            int iSections = _db.FormSections.Where(s => s.FormTypeCategoryId == 2).Count();
            if (iSections > 1)
            {

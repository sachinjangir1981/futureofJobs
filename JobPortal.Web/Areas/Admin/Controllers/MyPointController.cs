...
namespace JobPortal.Web.Areas.Admin.Controllers
{
    ...
    public class MyPointController : Controller
    {
        ...
        public MyPointController(IOneMinute oneMinute, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            try
            {
                ...
                var lst = _oneMinute.GetAllOneMinuteItem(3);
                return View(lst);
